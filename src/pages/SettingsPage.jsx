...
export default function SettingsPage() {
  ...
  return (
    <div className="max-w-[720px] mx-auto px-6 py-7">
      <h1 className="font-display font-bold text-[30px] text-slate-800 mb-1.5 tracking-[-0.5px]">
        Setări
      </h1>
      ...
      <div className="cad-card p-5 mb-4">
        <div className="flex items-center gap-2.5 mb-4">
          ...
          <h2 className="font-display font-semibold text-[17px] text-slate-700 m-0">
            Colegi
          </h2>
        </div>
        ...
        <div className="flex flex-col gap-2 mb-3.5">
          {colleagues.map((c) => (
            <div
              key={c.id}
              className="flex justify-between items-center bg-slate-50 rounded-xl px-3.5 py-2.5"
            >
        ...
        <div className="flex gap-2">
          <div className="flex-1">
            ...
            />
            {nameErr && (
              <div className="text-[11px] text-red-600 mt-0.5">{nameErr}</div>
            )}
          </div>
